  ...
  def cobra
    ...
    if @cobra_date.present? && @census_employee.can_elect_cobra?
      if @census_employee.update_for_cobra(@cobra_date, current_user)
        ...
        flash[:error] = "COBRA cannot be initiated for this employee because termination date is over 6 months in the past. Please contact Access Health CT at 855-532-5465 for further assistance."
      end
    else
