WELCOME_INDEX_TRANSLATIONS = {
  ...
  "en.welcome.index.byline" => "Connecticut's Official Health Insurance Marketplace",
  ...
  "en.welcome.index.site_byline" => "Connecticut's Official Health Insurance Marketplace"
}
