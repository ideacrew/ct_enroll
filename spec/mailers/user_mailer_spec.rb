...
RSpec.describe UserMailer do
  describe 'generic_notice_alert' do
    ...
    it "should have subject of #{Settings.site.short_name}" do
      expect(email.subject).to match(/Access Health CT/)
    end
  ...
  describe 'broker_staff_invitation_email' do
    ...
    it "should have subject of #{Settings.site.short_name}" do
      expect(email.subject).to match(/Invitation to create your Broker Staff account on Access Health CT/)
    end
  end
  ...
  describe '.send_employee_open_enrollment_invitation' do
    ...
    context 'should send invite_initial_employee_for_open_enrollment when census_employee DOH is in the past' do
      ...
      it 'should have subject' do
        expect(email.subject).to match(/Invitation from your Employer to Sign up for Health Insurance at Access Health CT/)
      end
