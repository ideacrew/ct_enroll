...
# module Prawn::Graphics
  ...
  def build_pdf
    ...
    @pdf.text_box "Access Health CT", :at => [address_x_pos,  @pdf.cursor]
    ...
    @pdf.page_count.times do |i|
      ...
      @pdf.bounding_box([0, @pdf.bounds.bottom + 25], :width => @pdf.bounds.width) {
        @pdf.text_box "Questions? Call Access Health CT Customer Service at 855-532-5465, go online to http://www.dchealthlink.com/, or contact your broker.", :at => [address_x, @pdf.bounds.height], :align => :center
      }
    end
  ...
  def payment_page_for_renewing_employer
    ...
    @pdf.move_down 24
    @pdf.text_box "Please review the billing summary. This is a consolidated bill for all your benefits through Access Health CT. Please pay the Total Amount Due.", :at => [address_x, @pdf.cursor]
    @pdf.move_down 36
    @pdf.text_box "Since your annual employee open enrollment period is still ongoing, this invoice reflects your employees’ enrollment activity on Access Health CT as of the day before the statement date. You can view your employee enrollments in your account at any time using the Enrollment Report available in your employer account on Access Health CT. Any adjustments resulting from your employees’ enrollment changes will appear on your next monthly invoice from Access Health CT. Please pay this invoice in full.", :at => [address_x, @pdf.cursor]
    ...
    @pdf.move_down 24
    @pdf.text_box "Access Health CT", :at => [240, @pdf.cursor]
    @pdf.move_down lineheight_y
    @pdf.text_box "PO Box 97022", :at => [240, @pdf.cursor]
    @pdf.move_down lineheight_y
    @pdf.text_box "Washington, DC 20090", :at => [240, @pdf.cursor]
    @pdf.move_down 24
    @pdf.text_box "\u2022 Call Access Health CT Customer Service at 855-532-5465", :at => [address_x, @pdf.cursor]
    @pdf.move_down 36
    ...
    @pdf.text_box "Access Health CT", :at => [320,  48]
  ...
  def payment_page_for_conversion_employer
    ...
    @pdf.text_box "Since your annual employee open enrollment period is still ongoing, this invoice reflects your employees’ enrollment activity on Access Health CT as of the day before the statement date You can view your employee enrollments in your account at any time using the Enrollment Report available in your employer account on Access Health CT. Any adjustments resulting from your employees’ enrollment changes will appear on your next monthly invoice from Access Health CT. Please pay this invoice in full.", :at => [address_x, @pdf.cursor]
    @pdf.move_down 72
    @pdf.text_box "You will now receive a monthly invoice from Access Health CT. Payments should be directed to Access Health CT for your health insurance coverage. You may receive one or two invoices from your health insurance company related to your current coverage purchased outside of Access Health CT. If you receive additional bills directly from your current health insurance company, please pay or contact them directly. If you continue to purchase dental or vision coverage directly from a health insurance company, you will continue to pay that company directly.", :at => [address_x, @pdf.cursor]
    @pdf.move_down 72
    @pdf.text_box "Payment Options", :at => [address_x, @pdf.cursor], :style => :bold
    @pdf.move_down 24
    @pdf.text_box "\u2022 Make a secure online electronic check payment. Use the account number found at the top of your invoice to login at:", :at => [address_x, @pdf.cursor]
  ...
  def payment_page_for_initial_employer
    ...
    @pdf.text_box "Access Health CT", :at => [320,  72]
