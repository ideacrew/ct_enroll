...
initDatepicker('eeDOB',new Date('05/01/1919'),new Date('05/01/2003'))
  
initDatepicker('hiredDate',new Date('04/17/2019'),new Date('05/08/2019'))
...
$(function() {
  ...
  initDatepicker('inputDOB',new Date('05/01/1929'),new Date('05/31/2001'));
});
