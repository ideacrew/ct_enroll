...
class LoadIssuerProfiles < MongoidMigrationTask
  ...
  def migrate
    issuer_profile_data = [
      {fein: "061475928", issuer_hios_ids: ["86545"], legal_name: "Anthem BlueCross BlueShield", abbreviation: "ABCBS", hbx_carrier_id: 20014, ivl_dental: true, shop_dental: true, shop_health: true },
      {fein: "237442369", issuer_hios_ids: ["76962"], legal_name: "ConnectiCare", abbreviation: "CCARE", hbx_carrier_id: 20015, shop_health: true, shop_dental: true },
