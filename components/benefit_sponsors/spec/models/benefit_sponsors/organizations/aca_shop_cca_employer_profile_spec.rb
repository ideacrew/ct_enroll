...
module BenefitSponsors
  RSpec.describe Organizations::AcaShopCcaEmployerProfile, type: :model, dbclean: :after_each do
    ...
    let(:benefit_market)      { ::BenefitMarkets::BenefitMarket.new(:kind => :aca_shop, title: "MA Access Health SHOP", site_urn: "site_urn", description: "description") }
    ...
    context "A BenefitSponsorship association", dbclean: :after_each do
      ...
      let(:benefit_market)      { ::BenefitMarkets::BenefitMarket.new(:kind => :aca_shop, title: "MA Access Health SHOP") }
      let(:legal_name)          { "MA Access Health" }
      let(:organization)        { BenefitSponsors::Organizations::GeneralOrganization.new(
                                      site: site,
                                      hbx_id: hbx_id,
                                      legal_name: legal_name,
