class Employers::BrokerAgencyController < ApplicationController
  ...
  def send_broker_assigned_msg(employer_profile, broker_agency_profile)
    broker_subject = "#{employer_profile.organization.legal_name} has selected you as the broker on Access Health CT"
    ...
    employer_subject = "You have selected #{broker_agency_profile.primary_broker_role.person.full_name} as your broker on Access Health CT."
